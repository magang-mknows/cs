...
const Sidebar: FC = (): ReactElement => {
      ...
      icon: (
        ...
        >
          ...
          <g mask="url(#mask0_1334_11329)">
            <path d="M-1.10522 -0.550293H19.1053V21.0497H-1.10522V-0.550293Z" fill="#9E9E9E" />
          </g>
        </svg>
      ),
    },
  ...
  const activeLink =
    "flex rounded-md cursor-pointer gap-2 p-2 items-center bg-primary-400 text-neutral-500";
  const normalLink =
    "flex rounded-md cursor-pointer gap-2 p-2 items-center bg-white text-neutral-500 hover:bg-primary-100 hover:text-neutral-500";
      ...
      >
        <div className="h-screen px-3 py-4  text-black bg-white border-b">
          ...
          <div className="pt-4 font-medium border-t w-full border-[#F5F5F5]  ">
            ...
            <Link to={"/auth/login"}>
              <div className="flex h-full gap-2 p-3 rounded-md mt-[80%] text-neutral-500 hover:bg-primary-400 hover:text-neutral-500 cursor-pointer items-end">
                <span>
                  <svg
                    width="18"
                    height="16"
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path d="M5.99814 8.00293H16.5047" stroke="#A3A3A3" strokeWidth="1.5" />
                    <path
